@extends('front-end.layouts.app',['pageTitle' => __('patient Registration')])
@section('content')
<main>
        ...
        <div class="container margin_120_95">
            <div class="row">
                ...
                <div class="col-lg-12 ml-auto">
                    <h1 class="offset-4 mb-5">Patient Registration</h1>

                    <div class="box_form">
                        <form method="POST" id="oneTimeSubmit" action="{{ url('/admin/patient') }}"
                                ...
                                <div class="col-6">
                                    <div class="form-group {{ $errors->has('surname') ? 'has-error' : ''}}">
                                        ...
                                        <input class="form-control" name="surname" type="text" id="surname"
                                            value="{{ isset($patient->surname) ? $patient->surname : old('surname')}}"
                                            required>
                                ...
                                <div class="col-4">
                                    <div class="form-group {{ $errors->has('parent_name') ? 'has-error' : ''}}">
                                        <label for="parent_name"
                                            class="control-label">{{ __(' parent/Guardian Name ') }}</label>
                                ...
                                <div class="col-4">
                                    <div class="form-group {{ $errors->has('patient_DOB') ? 'has-error' : ''}}">
                                        <label for="patient_DOB"
                                            class="control-label">{{ __('DOB of the patient') }}</label>
                                ...
                                <div class="col">
                                    <div class="form-group {{ $errors->has('telephone_number') ? 'has-error' : ''}}">
                                        <label for="telephone_number"
                                            class="control-label">{{ __('Telephone number ') }}</label>
                                ...
                                <div class="col">
                                    <div class="form-group {{ $errors->has('telephone_number2') ? 'has-error' : ''}}">
                                        <label for="telephone_number2"
                                            class="control-label">{{ __('Telephone number ') }}</label>
                                        <input class="form-control" name="telephone_number2" type="text"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="radio"
                                                            ...
                                                            value="yes" class="table-input" name="Bad_smell_from_mouth">
                                                    </td>
                                                    <td><input type="radio"
                                                            {{ isset($patient->Bad_smell_from_mouth) ? $patient->Bad_smell_from_mouth == 'no' ? 'checked' :'' : ''}}
                                                            value="no" class="table-input" name="Bad_smell_from_mouth">
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="radio" value="yes"
                                                            ...
                                                            class="table-input" name="fell_down_and_injury_to_teeth">
                                                    </td>
                                                    <td><input type="radio" value="no"
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="radio"
                                                            ...
                                                            value="yes" class="table-input" name="lump_in_the_mouth">
                                                    </td>
                                                    <td><input type="radio"
                                                            {{ isset($patient->lump_in_the_mouth) ? $patient->lump_in_the_mouth == 'no' ? 'checked' :'' : ''}}
                                                            value="no" class="table-input" name="lump_in_the_mouth">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Wisdom tooth </td>
                                                    <td><input type="radio"
                                                            ...
                                                            value="yes" class="table-input"
                                                            name="referral_from_other_dentist"></td>
                                                    <td><input type="radio"
                                                            {{ isset($patient->referral_from_other_dentist) ? $patient->referral_from_other_dentist == 'no' ? 'checked' :'' : ''}}
                                                            value="no" class="table-input"
                                                            name="referral_from_other_dentist"></td>
                                                </tr>
                                                {{-- <tr>
                            ...
                            {{ isset($patient->cavity_cavities) ? $patient->cavity_cavities == 'yes' ? 'checked' :'' : ''}}
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="radio"
                                                            ...
                                                            value="yes" class="table-input" name="need_dental_implant">
                                                    </td>
                                                    <td><input type="radio"
                                                            {{ isset($patient->need_dental_implant) ? $patient->need_dental_implant == 'no' ? 'checked' :'' : ''}}
                                                            value="no" class="table-input" name="need_dental_implant">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Ugly teeth </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="radio"
                                                            ...
                                                            value="yes" class="table-input" name="discolored_teeth">
                                                    </td>
                                                    <td><input type="radio"
                    ...
                    <td><input type="radio"
                            {{ isset($patient->allergy) ? $patient->allergy == 'yes' ? 'checked' :'' : ''}} value="yes"
                                ...
                                <div class="form-group {{ $errors->has('smoking') ? 'has-error' : ''}}">
                                    ...
                                    <li><label for="">Frequency – how much per day /Number of cigarettes per day
                                        </label>
                                ...
                                <div class="form-group {{ $errors->has('blood_pressure') ? 'has-error' : ''}}">
                                    <label for="blood_pressure"
                                        class="control-label">{{ __('Blood pressure ') }}</label>
                                ...
                                <div class="form-group {{ $errors->has('Drugs ') ? 'has-error' : ''}}">
                                    ...
                                    <input type='file' name="Drugs" accept=".png, .jpg, .jpeg,.zip,.mp4"
                                        onchange="showMyImage(this,'Drugs  ')"
                                        value="{{ isset($patient->Drugs  ) ? $patient->Drugs   : old('Drugs')}}">
                                    <input type='text' name="oldDrugs"
                                        value="{{ isset($patient->Drugs  ) ? $patient->Drugs   : ''}}" hidden>
                                ...
                                <div class="form-group {{ $errors->has('radilogy_views ') ? 'has-error' : ''}}">
                                    <label for="radilogy_views"
                                        class="control-label">{{ __('X ray and  Radilogy views') }}</label><br>
                                    ...
                                    <input type='text' name="oldRadilogy_views"
                                        value="{{ isset($patient->radilogy_views  ) ? $patient->radilogy_views   : ''}}"
                                        hidden>
                                    <div class="avatar-upload">
                                        <div class="avatar-preview">
         ...
         please see before uploading
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group {{ $errors->has('image2') ? 'has-error' : ''}}">
                                            ...
                                            <input type='file' name="image2" accept=".png, .jpg, .jpeg,.zip,.mp4"
                                    ...
                                    <div class="col-4">
                                        <div class="form-group {{ $errors->has('image3') ? 'has-error' : ''}}">
                                            ...
                                            <input type='file' name="image3" accept=".png, .jpg, .jpeg,.zip,.mp4"
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group {{ $errors->has('image4') ? 'has-error' : ''}}">
                                            ...
                                            <input type='file' name="image4" accept=".png, .jpg, .jpeg,.zip,.mp4"
                                    ...
                                    <div class="col">
                                        <div class="form-group {{ $errors->has('image5') ? 'has-error' : ''}}">
                                            ...
                                            <input type='file' name="image5" accept=".png, .jpg, .jpeg,.zip,.mp4"
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div class="form-group {{ $errors->has('image6') ? 'has-error' : ''}}">
                                            ...
                                            <input type='file' name="image6" accept=".png, .jpg, .jpeg,.zip,.mp4"
                                    ...
                                    <div class="col-4">
                                        <div class="form-group {{ $errors->has('image7') ? 'has-error' : ''}}">
                                            ...
                                            <input type='file' name="image7" accept=".png, .jpg, .jpeg,.zip,.mp4"
                                    ...
                                    <div class="col-4">
                                        <div class="form-group {{ $errors->has('image8') ? 'has-error' : ''}}">
                                            ...
                                            <input type='file' name="image8" accept=".png, .jpg, .jpeg,.zip,.mp4"
                                ...
                                <div class="border p-5">
                                    ...
                                    <div class="form-group {{ $errors->has('mobile_no') ? 'has-error' : ''}}">
                                        <label for="mobile_no" class="control-label">{{ __('Mobile Number') }}
                                            <small><b></b></small></label>
                                        <div class="form-group">
                            ...
                            <p class="text-center add_top_30"><input type="submit" class="btn_1" value="Submit">
                            </p>
