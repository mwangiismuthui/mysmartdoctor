@extends('layouts.app',['pageTitle' => __(' Testimonial')])
@section('content')
...
<div class="col-md-12">
    <div class="card">
        <h6 class="card-header">{{ __(' Testimonial List') }}</h6>

        <div class="card-body">
            @if (Helper::authCheck('testimonial-create'))
            ...
            <form method="GET" action="{{ url('/admin/testimonials') }}" accept-charset="UTF-8"
            ...
            <div class="table-responsive mt-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if (Helper::authCheck('testimonial-edit'))
                                <a href="{{ url('/admin/testimonials/' . $item->id . '/edit') }}" title="Edit"><button
                                        class="btn btn-primary btn-sm"><i class="feather-16" data-feather="edit"></i>
                                    </button></a>
                                @endif
                                @if (Helper::authCheck('testimonial-delete'))
                                <form method="POST" id="deleteButton{{$item->id}}"
                                    action="{{ url('/admin/testimonials' . '/' . $item->id) }}" accept-charset="UTF-8"
                ...
                <div class="pagination-wrapper"> {!! $testimonials->appends(['search' =>
