@extends('layouts.app',['pageTitle' => __(' Page Add')])
@section('content')
...
@endcomponent
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{ url('/admin/page') }}" title="Back"><button
                    ...
                    <form method="POST" id="oneTimeSubmit" action="{{ url('/admin/page') }}" accept-charset="UTF-8"
